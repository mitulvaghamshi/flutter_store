...
void drawClock(web.HTMLElement root) {
  ...
  final ctx = canvas.getContext('2d') as Ctx2D?;
  if (ctx == null) throw 'No context found!';

  ctx.translate(size / 2, size / 2);
  root.appendChild(canvas);

  Timer.periodic(const Duration(seconds: 1), (_) => _drawClock(ctx, radius));
}
