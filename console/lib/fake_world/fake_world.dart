...
import 'package:console/fake_world/warrior/fighter.dart';
import 'package:console/fake_world/warrior/hobbit.dart';
import 'package:console/fake_world/warrior/human.dart';
import 'package:console/fake_world/warrior/humanoid.dart';
import 'package:console/fake_world/warrior/wizard.dart';
...
extension on FakeWorld {
  ...
  String _chooseClan() {
    ...
    return getResidence(preferCity: choice == 1);
  }
  ...
  Humanoid _chooseWarrior(WarriorType type) {
    ...
    if (items.isEmpty) {
      ...
      final warrior = switch (type) {
        .elf => Elf(name: Warrior.any),
        .hobbit => Hobbit(name: Warrior.any),
        .wizard => Wizard(name: Warrior.any),
        _ => throw ArgumentError.value(type, 'WarriorType'),
      };
      items.add(warrior);
  ...
  void _buildWarrior(WarriorType type) {
    ...
    if (input.toLowerCase() == 'y') {
      _warriors.add(switch (type) {
        ...
        .hobbit => Hobbit(name: Warrior.any),
        .wizard => Wizard(name: Warrior.any),
        .fighter => Fighter(name: Warrior.any),
        .human => Human(name: Warrior.any),
