...
import 'package:flutter_store/ajson_app/models/contact.dart';
...
class ContactScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => PageBuilder(
    ...
    builder: (contacts) => CustomScrollView(
      slivers: [
        ...
        SliverSafeArea(
          ...
          sliver: SliverList.builder(
            ...
            itemBuilder: (_, index) =>
                _ContactListItem(contact: contacts.elementAt(index)),
          ),
        ),
      ],
    ),
...
class _ContactListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) => CupertinoListTile(
    ...
    trailing: CupertinoButton(
      onPressed: () {},
      child: const Icon(CupertinoIcons.mail, color: CupertinoColors.activeBlue),
    ),
  );
}
