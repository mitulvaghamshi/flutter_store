import 'package:flutter_store/istore_app/models/product.dart';
import 'package:flutter_store/istore_app/utils/category.dart';

mixin Server {
  static Iterable<Product> getProductsBy(Category category) => category == .all
      ? _products
      : _products.where((p) => p.category == category);

  static Iterable<Product> search(Category category, String term) {
    final products = getProductsBy(category);
  ...
  static Product getProductBy(int id) =>
